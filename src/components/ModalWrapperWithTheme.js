...
class ModalWrapperWithThemeSupport extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const modalStyle = [
            styles.modal,
            // by shoutem's connectStyle it merge customized styles (like this component's styles below) into .style props. here only requires those styles can be accepted by Animated.View. or RN raise warning.
            _.omit(style, ['container', 'modal', 'overlay', 'overlayWrapper']),
...
ModalWrapperWithThemeSupport.propTypes = {
...
ModalWrapperWithThemeSupport.defaultProps = {
...
export default connectStyle('shoutem.ui.ModalWrapperWithThemeSupport', styles)(ModalWrapperWithThemeSupport);